...
final class ShippingMethodsApiService
{
    /**
     * @var string
     */
    private const API_URL = ShoptetApi::API_URL . '/api/shipping-methods';
     ...
     */
    public function listOfShippingMethods(int $eshopId): array
    {
        ...
        return $responseAsArray['data']['shippingMethods'];
    }
}
